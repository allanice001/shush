...
from shush.utils import dump_config, error, info, success
from shush.models import Conversation, Finding, User, db
from shush.secrets import Secrets
from shush.slackwrapper import SlackWrapper
...
class Shush:
    ...
    def exported(self):
        ...
        with db_session:
            ...
            onlydirs = [f for f in listdir(self.args.get('exported_dir')) if
                        not isfile(join(self.args.get('exported_dir'), f))]
            for dir in onlydirs:
    ...
    def process_rtm_file_created(self, payload):
        ...
        # and warn the user when running out of disk space ... but ... time ............
